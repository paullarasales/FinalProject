...
<body class="font-sans antialiased">
    <div class="relative min-h-screen md:flex">
        <!-- Sidebar -->
        <aside class="z-10 bg-customBlue text-customWhite w-64 px-2 py-4 absolute inset-y-0 left-0 md:relative transform -translate-x-full md:translate-x-0 overflow-y-auto transition ease-in-out-200 shadow-lg">
            <!-- Logo -->
            <div class="flex items-center justify-between px-2 py-1">
                <div class="flex items-center">
                    <span class="text-2xl font-sm">Admin Panel</span>
                </div>
