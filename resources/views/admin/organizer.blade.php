<x-admin-layout>
    <div class="flex flex-col h-screen w-full">
        ...
        <div class="flex flex-row p-6 h-5/6 w-9/12 gap-2 ">
            <form method="POST" action="{{ route('organizer.create') }}">
                @csrf
                <!-- head -->
                ...
                <div class="flex flex-row h-1/5 w-max">
                    <div class="flex flex-col w-96">
                        <label for="position">School Postion</label>
                ...
                <div class="flex flex-row h-100 gap-10">
                    ...
                    <div>
                        <button type="button" class="outline-none border-0 bg-red-700 text-customWhite h-10 w-32 rounded">
                            {{ __('Cancel') }}
                        </button>
                    </div>
                </div>
